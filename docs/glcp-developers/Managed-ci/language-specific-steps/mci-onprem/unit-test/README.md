...
3. Run [SonarQube scanning](https://github.com/hpe-actions/sonarqube-scan)
4. [Backup](https://github.com/glcp/mci-actions-workspace-backup/tree/v1) the workspace to the
